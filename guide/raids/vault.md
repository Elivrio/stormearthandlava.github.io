...
- Always remember that you can increase your maximum health by an additional 15 % and the uptime of {{ site.data.spell.primordial_bond }} by using {{ site.data.spell.ee }} provided it does not interfere with your Primal Fire/Storm Elemental usage when {{ site.data.spell.pe }} is talented which also gives access to an additional single target stun ({{ site.data.spell.pulverize }}).

- Recall that [Stampeding Roar](https://www.wowhead.com/spell=106898/stampeding-roar) is now more potent than {{ site.data.spell.wind_rush_totem }}. Depending on your raid comp, it may be better to spend that talent point somewhere else.
...
* Use {{ site.data.spell.stormkeeper }} when [Flamescale Tarasek](https://www.wowhead.com/npc=187638/flamescale-tarasek) are spawning, consider having a {{ site.data.spell.sop }} buff active!
...
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst dealing with [Flamerift](https://www.wowhead.com/spell=390715/flamerift).

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required whenever you accumulate more stacks of [Incinerating Roar](https://www.wowhead.com/spell=396023/incinerating-roar).
...
* Use {{ site.data.spell.thunderstorm }} if necessary to keep distance when chased by [Kill Order](https://www.wowhead.com/spell=370597/kill-order) from [Flamescale Tarasek](https://www.wowhead.com/npc=187638/flamescale-tarasek).
* Use {{ site.data.spell.capacitor_totem }} and {{ site.data.spell.earthbind_totem }} to keep [Flamescale Tarasek](https://www.wowhead.com/npc=187638/flamescale-tarasek) stacked as soon as they spawn.
...
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst repositioning for either [Rock Blast](https://www.wowhead.com/spell=380487/rock-blast) or [Infused Fallout](https://www.wowhead.com/spell=391592/infused-fallout) (Mythic).
* Preemptive movement is very important. Many abilities demand you to move quickly in a certain direction so optimizing your positioning in advance will give you the opportunity to use {{ site.data.spell.gow }} for more difficult situations.

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required whenever you accumulate more stacks of [Seismic Assault](https://www.wowhead.com/spell=381576/seismic-assault).
* If talented, keep {{ site.data.spell.earth_shield }} up, use it as a movement filler throughout the fight.
* Use {{ site.data.spell.healing_surge }} if necessary.

**Utilities:**

* If talented, use {{ site.data.spell.wrt }} to help your raid repositioning for [Rock Blast](https://www.wowhead.com/spell=380487/rock-blast).

**Added Notes:**

* Both {{ site.data.spell.swg }} and {{ site.data.spell.gow }} are not necessarly needed for [Resonating Annihilation](https://www.wowhead.com/spell=377166/resonating-annihilation) since [Demonic Gateway](https://www.wowhead.com/spell=111771/demonic-gateway) will be ready for it.
...
* Maintain {{ site.data.spell.fs }} on all targets to utilize {{ site.data.spell.splinter }}, {{ site.data.spell.magma_chamber }} and {{ site.data.spell.sfd }}.
* There are no phases or timings that require you to plan your cooldowns around.
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst dealing with [Primal Blizzard](https://www.wowhead.com/spell=371836/primal-blizzard)

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required for overlaps of [Meteor Axe](https://www.wowhead.com/spell=374043/meteor-axe) and [Conductive Mark](https://www.wowhead.com/spell=391686/conductive-mark).
* If talented, keep {{ site.data.spell.earth_shield }} up, use it as a movement filler throughout the fight.
* Use {{ site.data.spell.healing_surge }} if necessary.
...
* If talented, use {{ site.data.spell.wrt }} to help your raid dealing with [Meteor Axe](https://www.wowhead.com/spell=374043/meteor-axe) and [Conductive Mark](https://www.wowhead.com/spell=391686/conductive-mark).
...
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst dealing with [Gossamer Burst](https://www.wowhead.com/spell=373405/gossamer-burst) and other movement heavy portions of the fight.

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required whenever [Frostbreath Arachnids](https://www.wowhead.com/npc=199333/frostbreath-arachnid) are up to mitigate overlaps of [Chilling Blast](https://www.wowhead.com/spell=371976/chilling-blast) and [Chilling Aura](https://www.wowhead.com/spell=373817/chilling-aura).
* Use {{ site.data.spell.stoneskin_totem }} for [Gossamer Burst](https://www.wowhead.com/spell=373405/gossamer-burst).
* Use {{ site.data.spell.healing_surge }} if necessary.

**Utilities:**

* Use {{ site.data.spell.capacitor_totem }} and {{ site.data.spell.thunderstorm }} to gather and stun [Caustic Spiderlings](https://www.wowhead.com/npc=189233/caustic-spiderling) if necessary.
* If talented, use {{ site.data.spell.wrt }} to help your raid repositioning during intermissions.
...
* Use {{ site.data.spell.sk }} optimally with {{ site.data.spell.sop }} active to burst down [Thunder Caller](https://www.wowhead.com/npc=194647/thunder-caller).
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst dealing with [Conductive Mark](https://www.wowhead.com/spell=391686/conductive-mark) and [Cyclone](https://www.wowhead.com/spell=376943/cyclone).

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required for [Conductive Mark](https://www.wowhead.com/spell=391686/conductive-mark) and [Cyclone](https://www.wowhead.com/spell=376943/cyclone).
* Use {{ site.data.spell.healing_surge }} if necessary.
...
* Use {{ site.data.spell.capacitor_totem }} and {{ site.data.spell.thunderstorm }} to gather and stun [Thunder Caller](https://www.wowhead.com/npc=194647/thunder-caller) if necessary.
* If talented, use {{ site.data.spell.wrt }} to help your raid dealing with [Cyclone](https://www.wowhead.com/spell=376943/cyclone).

**Added Notes:**

* {{ site.data.spell.gow }} can also be used to jump back to the boss after dealing with the adds on the platforms.
...
* If talented, use {{ site.data.spell.sk }} when [Earth Breakers](https://www.wowhead.com/npc=190586/earth-breaker) are spawning.
...
* Use {{ site.data.spell.spiritwalkers_grace }} and {{ site.data.spell.gust_of_wind }} to maintain uptime whilst dealing with [Searing Carnage](https://www.wowhead.com/spell=374023/searing-carnage) (Mythic) and [Thunder Strike](https://www.wowhead.com/spell=374217/thunder-strike).
...
* If talented, use {{ site.data.spell.wrt }} to help your raid repositioning whenever you are switching altars.
...
* Use {{ site.data.spell.sk }} to burst down add waves during Phase 1.
...
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime whilst targeted by [Empowered Greatstaff's Wrath](https://www.wowhead.com/spell=380483/empowered-greatstaffs-wrath).

**Defensives:**

* Use {{ site.data.spell.as }} and healing consumables as required for overlaps of [Chilling Tantrum](https://www.wowhead.com/spell=375457/chilling-tantrum), [Icy Shroud](https://www.wowhead.com/spell=388716/icy-shroud) and potentially [Clutchwatcher's Rage](https://www.wowhead.com/spell=375829/clutchwatchers-rage).
* If talented, keep {{ site.data.spell.earth_shield }} up, use it as a movement filler throughout the fight.
* Use {{ site.data.spell.healing_surge }} if necessary.
...
* Use {{ site.data.spell.capacitor_totem }} and {{ site.data.spell.thunderstorm }} to gather and stun adds waves if necessary.
* Use {{ site.data.spell.spirit_walk }} to free yourself from [Frozen Shroud](https://www.wowhead.com/spell=388918/frozen-shroud).
* If talented, use {{ site.data.spell.wrt }} to help your raid reposition when new add waves are about to spawn.
...
**Damage:**
* During intermissions, use {{ site.data.spell.sk }} and {{ site.data.spell.lmt }} to burst the adds.
* In P2, keep offensive CDs for [Stormsurge](https://www.wowhead.com/spell=387261/stormsurge), notably {{ site.data.spell.sk }}.
* Use {{ site.data.spell.swg }} to maintain uptime whilst dealing with [Static Charge](https://www.wowhead.com/spell=381615/static-charge) (P1 bomb) and [Fulminating Charge](https://www.wowhead.com/spell=377467/fulminating-charge) (P2 & P3 Bomb).

**Defensives:**
* Use {{ site.data.spell.as }}, or even {{ site.data.item.potion_rhp }} and {{ site.data.externals.hs }} if needed, when away from the raid to drop [Static Charge](https://www.wowhead.com/spell=381615/static-charge) (P1 bomb) and [Fulminating Charge](https://www.wowhead.com/spell=377467/fulminating-charge) (P2 & P3 bomb).
* Use {{ site.data.spell.healing_surge }} if necessary.
* If talented, use {{ site.data.spell.ag }} to help healers, notably during [Stormsurge](https://www.wowhead.com/spell=387261/stormsurge) (P2).

**Utilities:**

* Use {{ site.data.spell.capacitor_totem }}, {{ site.data.spell.thunderstorm }}, {{ site.data.spell.wind_shear }} and {{ site.data.spell.purge }} to destroy [Volatile Spark](https://www.wowhead.com/npc=194999/volatile-spark) rapidly.
* In P2, {{ site.data.spell.thunderous_paws }} dispels [Fulminating Charge](https://www.wowhead.com/spell=377467/fulminating-charge) slow, allowing you to quickly move out. Try to not use {{ site.data.spell.ghost_wolf }} during P2 and P3, except if you get that debuff.
...
* In P2 and P3, use {{ site.data.spell.gust_of_wind }} to rapidly go through [Tempest Wing](https://www.wowhead.com/spell=385574/tempest-wing).
* If talented, use {{ site.data.spell.wrt }} to help your raid repositioning during intermissions, [Hurricane Wing](https://www.wowhead.com/spell=377612/hurricane-wing) (P1) and [Tempest Wing](https://www.wowhead.com/spell=385574/tempest-wing) (P2 & P3).
...
*Note: {{ site.data.spell.gust_of_wind }} is best used once the wind is over to quickly come back into melee range or even to jump back onto the platform.*
1. {{ site.data.spell.swg }} before, {{ site.data.spell.gust_of_wind }} after.
2. {{ site.data.externals.demonic_gateway }} during, {{ site.data.spell.gust_of_wind }} after.
3. - With an Evoker's {{ site.data.externals.time_spiral }}: {{ site.data.spell.swg }} before, {{ site.data.spell.ghost_wolf }} if needed during, {{ site.data.spell.gust_of_wind }} after.
   - Without {{ site.data.externals.time_spiral }}: {{ site.data.spell.ghost_wolf }} before, {{ site.data.spell.gust_of_wind }} after.
4. {{ site.data.spell.swg }} and {{ site.data.spell.ghost_wolf }} before, {{ site.data.spell.gust_of_wind }} after.
5. {{ site.data.spell.ghost_wolf }} before, {{ site.data.externals.demonic_gateway }} during, {{ site.data.spell.gust_of_wind }} after.
